...
def predictOneTrain_LSTM(shopid, all_data, trainAsTest=False):
    """
    用SRN预测某一个商店
    :param shopid: 预测商店id
...
def predict_all_LSTM(all_data, save_filename,trainAsTest = False):
    ...
    for i in range(2000):
        shopid = i + 1
        print "shopid:",shopid
        predict, real_14 = predictOneTrain_LSTM(shopid, all_data, trainAsTest)
        if trainAsTest:
...
if __name__ == "__main__":
    ...
    # print predict_all_LSTM(2, pay_info, True)
